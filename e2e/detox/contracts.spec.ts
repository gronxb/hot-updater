...
describe("Detox E2E harness contract", () => {
  ...
  it("keeps the tracked E2E source surface Detox-first", async () => {
    const expectedE2eFiles = [
      ...
      "e2e/detox/control-server/deploy-asset-guard.ts",
      "e2e/detox/control-server/deploy-fixture-reset.ts",
      ...
      "e2e/detox/control-server-lifecycle.spec.ts",
      ...
      "e2e/lynx/fixtures/hkmqe0/README.md",
      "e2e/lynx/fixtures/hkmqe0/android-s1-eligible.log",
      "e2e/lynx/fixtures/hkmqe0/android-s1-runtime-events.json",
      "e2e/lynx/fixtures/hkmqe0/android-s2-eligible.log",
      "e2e/lynx/fixtures/hkmqe0/android-s2-runtime-events.json",
      "e2e/lynx/generation-event-ledger.spec.ts",
      "e2e/lynx/generation-event-ledger.ts",
      "e2e/lynx/generation-events.spec.ts",
      "e2e/lynx/launch-configuration.spec.ts",
      "e2e/lynx/lynx-app-driver.spec.ts",
      "e2e/lynx/lynx-app-driver.ts",
      "e2e/lynx/managed-resource-errors.spec.ts",
      "e2e/lynx/managed-resource-errors.ts",
      "e2e/lynx/multipage-evidence.spec.ts",
      "e2e/lynx/multipage-evidence.ts",
      ...
      "e2e/lynx/runtime-channel-switch-reset-scenario.spec.ts",
      "e2e/lynx/runtime-observation.spec.ts",
      "e2e/lynx/scenario-runner.spec.ts",
      "e2e/lynx/scenario-runner.ts",
      "e2e/lynx/scenarios.ts",
      "e2e/lynx/scenarios/runtime-channel-switch-reset.ts",
      "e2e/lynx/scenarios/sparkling-multipage-ota.ts",
      "e2e/lynx/screen-state-publication.spec.ts",
      "e2e/lynx/sparkling-multipage-scenario.spec.ts",
