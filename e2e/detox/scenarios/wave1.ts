...
export const wave1Scenarios: readonly DetoxScenarioDefinition[] = [
  {
    ...
    steps: [
      ...
      {
        contains: "stable-detox-recovery",
        kind: "assertText",
      ...
      {
        body: { crashedBundleId: "$crashBundleId", status: "RECOVERED" },
        kind: "control",
        pathName: "/e2e/assert-launch-report",
      ...
      },
      {
        ...
        stage: "assert recovered metadata active",
      },
      {
        body: { bundleId: "$crashBundleId" },
        kind: "control",
        pathName: "/e2e/assert-crash-history",
        stage: "assert crash history",
      },
    ],
  },
];
