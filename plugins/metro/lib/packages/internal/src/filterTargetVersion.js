 ...
 */
export const filterTargetVersion = (sources, targetVersion, platform) => {
    var _a;
    // coerce currentVersion to a semver-compatible version
    const currentVersionCoerce = (_a = semver.coerce(targetVersion)) === null || _a === void 0 ? void 0 : _a.version;
    ...
    const filteredSources = sources
        ...
        semver.satisfies(currentVersionCoerce !== null && currentVersionCoerce !== void 0 ? currentVersionCoerce : "*", source.targetVersion));
