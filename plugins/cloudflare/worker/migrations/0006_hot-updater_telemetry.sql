-- Migration number: 0006 	 2026-06-29T00:00:00.000Z
...
CREATE TABLE bundle_lifecycle_events (
    id TEXT PRIMARY KEY,
...
CREATE TABLE bundle_install_state (
...
CREATE INDEX bundle_lifecycle_events_observed_idx
    ON bundle_lifecycle_events(observed_at);
CREATE INDEX bundle_lifecycle_events_crashed_bundle_idx
    ON bundle_lifecycle_events(crashed_bundle_id);
CREATE INDEX bundle_install_state_bundle_idx
