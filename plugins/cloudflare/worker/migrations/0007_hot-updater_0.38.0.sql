...
CREATE INDEX IF NOT EXISTS bundle_events_installed_bundle_idx
  ON bundle_events(type, to_bundle_id, received_at_ms, id);
CREATE INDEX IF NOT EXISTS bundle_events_recovered_bundle_idx
...
CREATE INDEX IF NOT EXISTS bundle_events_cohort_idx
