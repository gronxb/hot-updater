...
| `HOT_UPDATER_CLOUDFRONT_DISTRIBUTION_ID` | Required by the local metadata plugin for cache invalidation after deployment. | Query/create the distribution and record its ID, not its domain name. |
