...
// biome-ignore lint/suspicious/noConfusingVoidType: void is needed for utility type
            ...
            : E extends WeakSet<infer ItemType>
              ...
              : E extends Promise<infer ValueType>
                ...
                : E extends (...arguments_: any[]) => unknown
                  ? // biome-ignore lint/complexity/noBannedTypes: empty object check for utility type
