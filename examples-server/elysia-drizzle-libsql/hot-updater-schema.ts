...
export const bundle_events = sqliteTable("bundle_events", {
  ...
  active_bundle_id: text("active_bundle_id").notNull(),
  previous_active_bundle_id: text("previous_active_bundle_id"),
  crashed_bundle_id: text("crashed_bundle_id"),
  platform: text("platform").notNull(),
...
export const private_hot_updater_settings = sqliteTable("private_hot_updater_settings", {
  id: text("id", { length: 255 }).primaryKey().notNull(),
  version: text("version", { length: 255 }).notNull().default("0.32.0")
})
