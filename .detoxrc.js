...
module.exports = {
  ...
  apps: {
    ...
    "android.release": {
      ...
      build:
        `cd examples/v0.85.0/android && ./gradlew --no-daemon assembleRelease assembleAndroidTest -Pkotlin.compiler.execution.strategy=in-process -DtestBuildType=release -PreactNativeArchitectures=${androidArchitectures} -PHOT_UPDATER_E2E_DEBUGGABLE=true -PMIN_BUNDLE_ID=00000000-0000-7000-8000-000000000000`,
    },
  },
  devices: {
    simulator: {
