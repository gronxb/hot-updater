...
This boundary does not add Analytics models to Database V2, make plugin setup
migrate storage, install managed authentication, select a managed preset, or
add retention and deletion behavior. Managed Analytics and authentication
composition belongs to the later integration PR.
