...
- **`@hot-updater/rock`**: Builds Re.Pack projects through [Rock](https://github.com/callstack/rock) (formerly RNEF).
...
- `node`: deploy-time APIs for upload, existence checks, delete, and local file downloads.
