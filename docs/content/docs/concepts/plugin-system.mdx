...
- **`@hot-updater/bare`**: Runs React Native CLI's `bundle` command, which can be provided by Metro or Re.Pack.
- **`@hot-updater/rock`**: Runs the `rock bundle` command through [Rock](https://github.com/callstack/rock) (formerly RNEF).
