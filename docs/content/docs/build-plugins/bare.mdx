...
description: Build plugin for React Native CLI projects (non-Expo). Runs the React Native CLI bundle command provided by Metro or Re.Pack.
icon: react
---
...
- Runs React Native CLI's `bundle` command, provided by Metro or Re.Pack
