...
description: Build plugin for React Native CLI projects (non-Expo). Runs the project's configured bundler through the React Native CLI bundle command.
icon: react
---
...
- Runs the project's configured bundler through React Native CLI's `bundle` command
