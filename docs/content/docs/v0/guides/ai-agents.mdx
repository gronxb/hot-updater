...
The Hot Updater skill gives AI coding agents instructions for OTA operations.
Attach it from GitHub:
...
The agent uses the skill's CLI instructions to carry out those requests with
`npx hot-updater ...`.
