...
<Callout type="warn">
The environment variables in `.env` are used only during deployment, not in your app bundle. However, if you're using `react-native-dotenv`, review the [Security guidelines](/docs/v0/policy/security#plugin-token-protection).
</Callout>
...
- [Update Strategies](/docs/v0/guides/update-strategies) - Choose between app version and fingerprint strategies
