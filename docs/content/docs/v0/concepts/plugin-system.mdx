...
- `node`: deploy-time APIs for upload, existence checks, deletion, and local
  file downloads.
...
- **`@hot-updater/cloudflare`**: Provides universal `r2Storage` through R2 S3-compatible credentials and a Worker binding runtime export.
