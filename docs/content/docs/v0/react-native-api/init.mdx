...
Use `HotUpdater.init` to initialize a custom update flow without wrapping your
root component with `HotUpdater.wrap`. Call it once when your runtime considers
the app ready. Initialization does not create a React HOC.
...
- [Custom Update](/docs/v0/guides/custom-update)
