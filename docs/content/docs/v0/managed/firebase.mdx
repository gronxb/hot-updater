...
- `hot-updater.config.ts`: Configures Firebase integration for your project.
...
<Callout type="info">
If you use Expo DOM components (`use dom`), see the [Expo DOM Components (`use dom`)](/docs/v0/build-plugins/expo#expo-dom-components-use-dom) section for the additional Babel plugin setup.
</Callout>
