...
```
GET {baseUrl}/v2/release-catalogs/fingerprint/:authorityId/:platform/:channelKey/:fingerprintHash
```
...
```bash
curl "https://your-update-endpoint.com/check-update/v2/release-catalogs/fingerprint/default/ios/cHJvZHVjdGlvbg/11142b9062165fa48665f5efa095dd94e9e45eb0"
```
