...
Databases that expose the optional bundle-event capability show Installed and
Recovered counts in bundle details, together with a 30-day cumulative activity
chart.

<img src={"/docs/console/update-activity.jpg"} />

Use the Installations page to search by username, user ID, or installation ID
and inspect the recorded bundle-event history for a selected installation.
