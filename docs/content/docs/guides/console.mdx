...
The deployable app imports that config and passes it to
`@hot-updater/console/hosted`. The package owns the console component and API
adapter; the deployable app owns provider selection, credentials, auth, and
Nitro deployment.
