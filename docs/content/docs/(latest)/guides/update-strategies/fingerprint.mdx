...
Use the [client-access check](/docs/guides/simulator-test#verify-client-access)
with the saved client key to verify the catalog, then
[test OTA delivery](/docs/guides/simulator-test).

```bash
curl "https://your-update-endpoint.com/release-catalogs/fingerprint/ios/cHJvZHVjdGlvbg/11142b9062165fa48665f5efa095dd94e9e45eb0"
```
