...
```
GET {baseUrl}/release-catalogs/fingerprint/:authorityId/:platform/:channelKey/:fingerprintHash
```
...
```bash
curl "https://your-update-endpoint.com/release-catalogs/fingerprint/default/ios/cHJvZHVjdGlvbg/11142b9062165fa48665f5efa095dd94e9e45eb0"
```
