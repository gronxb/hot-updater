...
Without `wrap` or `init`, calling `checkForUpdate` throws an error with
configuration instructions. For a full manual integration, see
[custom update flows](/docs/guides/custom-update).
