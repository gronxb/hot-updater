...
such as GraphQL, RPC, or custom authentication, expose the Hot Updater HTTP
protocol through an adapter or proxy and point `baseURL` at that endpoint. The adapter
