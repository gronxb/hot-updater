...
- **`@hot-updater/bare`**: Runs the project's React Native CLI `bundle`
  command, which can use Metro or Re.Pack based on the CLI configuration.
- **`@hot-updater/rock`**: Runs the `bundle` command through the
  [Rock CLI](https://github.com/callstack/rock) (formerly RNEF).
