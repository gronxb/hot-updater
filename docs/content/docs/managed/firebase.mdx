...
in Firestore only as a hash/suffix and is not written to env files or provider
config.
...
export default HotUpdater.wrap({
  baseURL: "https://<your-firebase-function-url>", // [!code ++]
  analytics: {
