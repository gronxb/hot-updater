...
logging, and retention for your deployment. The managed preset does not expose
an inline authorization hook; use a custom server runtime when your app must
verify an end-user credential or attestation. See
