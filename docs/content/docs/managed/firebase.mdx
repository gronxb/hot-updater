...
## Step 5: Expo DOM Babel Configuration (Optional)
...
Complete this step only if your Expo app uses DOM components with `use dom`.

Customize your Babel configuration and add `hot-updater/babel-plugin`:
