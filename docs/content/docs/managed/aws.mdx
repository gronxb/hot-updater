...
1. **Select a Build Adapter**: Choose a build adapter for your project (e.g., Bare (React Native CLI) for React Native).
...
[Security](/docs/policy/security#adapter-token-protection)
...
<Callout type="info">
  ...
  dom`)](/docs/build-adapters/expo#expo-dom-components-use-dom) section for the
