...
**2. Use Any Bundler**
Works with Metro, Re.Pack, or any bundler through build adapters.

## How It Works

Hot Updater uses a [Adapter System](../concepts/adapter-system) that separates concerns:
- **Build Adapters**: Handle bundling (Metro, Re.Pack, Expo, Rock)
- **Storage Adapters**: Store bundles anywhere (S3, R2, Supabase, Firebase)
- **Database Adapters**: Manage metadata (PostgreSQL, D1, Firestore)
