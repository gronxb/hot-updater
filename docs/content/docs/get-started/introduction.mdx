...
- Only supported Metro bundler, limiting build flexibility
...
**2. Use Any Bundler**
Works with Metro, Expo, Rock, or custom bundlers through the plugin system.

## How It Works

Hot Updater uses a [Plugin System](../concepts/plugin-system) that separates concerns:
- **Build Plugins**: Handle bundling (Metro, Expo, Rock)
