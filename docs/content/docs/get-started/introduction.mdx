...
**2. Use Any Bundler**
Works with Metro, Re.Pack, or any bundler through build plugins.

## How It Works

Hot Updater uses a [Plugin and Adapter System](../concepts/plugin-system) that separates concerns:
