...
<Callout type="warn">
  Analytics is currently unavailable for Cloudflare D1 and Worker D1. The
  Console hides Analytics based only on whether the database advertises the
  bundle-event capability.
</Callout>
