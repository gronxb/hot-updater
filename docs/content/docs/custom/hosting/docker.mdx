...
Install your chosen storage adapter separately (e.g., `@hot-updater/aws`, `@hot-updater/supabase`, `@hot-updater/firebase`).
...
export const hotUpdater = createHotUpdater({
  ...
  storages: [
    // Configure your storage adapter - examples:
...
<Callout type="warn">
The `storage` adapter must match the `storages` in your server's `createHotUpdater`.
</Callout>
