...
These endpoints are automatically created when you use `@hot-updater/server`
with a database middle layer or native database option.
...
- [Database Middle Layers](./database/drizzle) - Drizzle, Prisma, Kysely; native MongoDB and S3 options
