...
be protected by framework middleware when enabled. The `/version` endpoint is
always mounted for diagnostics. If you provide `routes`, specify both
configurable route groups.
