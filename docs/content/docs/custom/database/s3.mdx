...
<Callout type="warn">
When mounting Hot Updater with Hono, keep `/hot-updater/app-version/*` and `/hot-updater/fingerprint/*` public. If `routes.bundles` is enabled, protect `/hot-updater/version` and `/hot-updater/api/*`.
</Callout>
