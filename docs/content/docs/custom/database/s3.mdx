...
<Callout type="warn">
  `s3Database` does not support OTA transition analytics. It replaces a shared
...
Transition-event ingestion, analytics, and installation-history endpoints are
not mounted for `s3Database`.
