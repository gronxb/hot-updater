...
Point Drizzle Kit at the generated schema:
...
This command writes `hot-updater-schema.ts`; it does not modify the
database. Apply that schema before starting the server:
