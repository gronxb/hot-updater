...
See the [Self-Hosting Guide](../self-hosting/overview) for complete server implementation instructions using `@hot-updater/server` with database adapters (Drizzle, Prisma, Kysely, MongoDB) and frameworks (Hono, Express, Elysia).
</Callout>
...
- [CLI Configuration](../self-hosting/cli-configuration) - Complete CLI configuration guide
- [Self-Hosting Overview](../self-hosting/overview) - Learn about the architecture
- [Quick Start Guide](../self-hosting/quick-start) - Set up a server in 5 minutes
- [Database Adapters](../self-hosting/database/drizzle) - Choose your ORM (Drizzle, Prisma, Kysely, MongoDB)
- [Server Frameworks](../self-hosting/frameworks/hono) - Choose your framework (Hono, Express, Elysia)
