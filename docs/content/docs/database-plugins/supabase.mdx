...
This interactive command will guide you through the setup process. For details on what the init command does, see the [Supabase](/docs/managed-hosting/supabase) documentation.
