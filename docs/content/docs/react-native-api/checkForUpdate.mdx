...
When using `checkForUpdate`, you must wrap your root component with `HotUpdater.wrap()`. This is required for proper crash detection and rollback functionality.
...
// Wrap your app (notifyAppReady will be called automatically)
