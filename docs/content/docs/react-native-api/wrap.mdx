...
Protocol-v2 custom resolvers implement `fetchReleaseCatalog` and
...
* App version catalog: `GET {baseURL}/v2/release-catalogs/app-version/:authorityId/:platform/:channelKey/:appVersion`
* Fingerprint catalog: `GET {baseURL}/v2/release-catalogs/fingerprint/:authorityId/:platform/:channelKey/:fingerprintHash`
* Artifact resolution: `GET {baseURL}/v2/artifacts/:targetBundleId/from/:currentBundleId`
