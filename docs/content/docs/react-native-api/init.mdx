...
| `analytics`        | `boolean`                                   | No       | Enables best-effort OTA transition reporting (default: `false`)          |
...
<Callout type="warn">
  Transition analytics also require support from the server's database
  adapter. This storage capability is optional.
</Callout>
