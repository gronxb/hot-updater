...
- Datadog site: in order to communicate with Datadog, specify the site for the Auth token using the environment variable `DATADOG_SITE` (e.g., `DATADOG_SITE=datadoghq.eu`)
- Install the plugin:
