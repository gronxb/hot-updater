...
`firebaseStorage` implements the full storage operation set:

- uploads, deletes, and downloads local files during CLI/console workflows.
- creates Firebase download URLs and reads small metadata files directly
  through Cloud Storage APIs.
