...
<video src={normalizeImagePath("/guide/getting-started/init-firebase.mov")} controls autoPlay loop muted />
...
export default HotUpdater.wrap({ 
  source: "https://<your-firebase-function-url>/api/check-update", // [!code ++]
  requestHeaders: {
...
## Step 5: Add Babel / Repack Plugin to Your Project
...
<PackageManagerTabs command={
  {
    npm: "npm install @hot-updater/repack",
    pnpm: "pnpm add @hot-updater/repack",
    yarn: "yarn add @hot-updater/repack",
  }
} />
