...
Generate the Kysely type definitions for Hot Updater tables.
...
- `npx hot-updater db generate` - Creates SQL migration files for manual review
- `npx hot-updater db migrate` - Runs Kysely migrator to apply migrations to the database
</Callout>
