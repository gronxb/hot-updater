...
The `storage` plugin in your CLI config must match the `storagePlugins` in your server's `createHotUpdater` configuration.
...
- [Build Plugins](../build-plugins) - React Native CLI, Expo, Re.Pack
- [Storage Plugins](../storage-plugins) - AWS S3, Supabase, Firebase, Cloudflare R2

**Set up your server:**
- [Quick Start Guide](./quick-start) - Set up a server in 5 minutes
- [Database Adapters](./database) - Drizzle, Prisma, Kysely, MongoDB
- [Server Frameworks](./frameworks) - Hono, Express, Elysia
