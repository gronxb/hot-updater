...
This interactive command will guide you through the setup process. For details on what the init command does, see the [Firebase](/docs/managed-hosting/firebase) documentation.
