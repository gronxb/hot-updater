...
2. **Provider Selection**: Select from available providers:
   - [Supabase](/docs/managed-hosting/supabase)
   - [Firebase](/docs/managed-hosting/firebase)
   - [Cloudflare](/docs/managed-hosting/cloudflare)
   - [AWS](/docs/managed-hosting/aws)
...
<Callout type="info">
For detailed provider-specific setup instructions, see the [Managed Hosting](/docs/managed-hosting/supabase) documentation.
</Callout>
...
export default HotUpdater.wrap({
  source: getUpdateSource("https://your-update-server-url/api/check-update", { // [!code ++]
