...
- [Database Adapters](../self-hosted/database) - Choose your ORM (Drizzle, Prisma, Kysely, MongoDB)
- [Server Frameworks](../self-hosted/frameworks) - Choose your framework (Hono, Express, Elysia)
