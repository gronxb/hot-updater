// allow: SIZE_OK — existing table owns desktop/mobile layouts; G004 only gates delete action.
...
export function BundlesTable({
  ...
  const canDeleteBundles = deleteCapability?.supported === true;
  const deleteDisabledReason =
    deleteCapability?.reason ??
    (capabilities ? undefined : "Loading console capabilities");
        ...
        <div className="flex flex-wrap items-center gap-3 sm:justify-end">
          {selectedBundles.length > 0 ? (
            <Button
              ...
              disabled={!canDeleteBundles}
              title={!canDeleteBundles ? deleteDisabledReason : undefined}
            >
