// allow: SIZE_OK — dialog regression suite covers existing promote flow states plus G004 capability gates.
...
describe("PromoteChannelDialog", () => {
  ...
  it("blocks unsupported copy promotion before calling the mutation", () => {
    const capabilities = createSupportedConsoleCapabilities();
    capabilities.promoteBundleCopy = {
      supported: false,
      reason: "storage cannot copy bundles",
    };
