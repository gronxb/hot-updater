...
function ActivityPage() {
  ...
  const columns: Array<DataGridColumn<DeviceData>> = [
    ...
    },
    {
      ...
      render: (device) => <span className="font-semibold">{device.total.toLocaleString()}</span>,
    },
    {
      key: "lastSeen",
      header: "Last Seen",
      ...
      render: (device) => (device.lastSeen ? dayjs(device.lastSeen).fromNow() : "-"),
    },
  ];
  ...
  return (
    ...
    >
      <AnalyticsSection
        title="Device Event Ledger"
        description="Per-device event totals and most recent activity."
        action={
          <div className="flex flex-wrap items-center gap-2 justify-end">
            ...
            <div className="flex items-center gap-2 rounded-md border border-[var(--panel-border)] bg-[var(--panel-surface)] px-3 py-1.5">
              <input
                type="checkbox"
                id="recoveredOnly"
              ...
              />
              <Label htmlFor="recoveredOnly" className="text-xs whitespace-nowrap">
                Recoveries only
              </Label>
            </div>
          </div>
              ...
              empty={
                <div className="rounded-xl border border-[var(--panel-border)] bg-[var(--panel-surface)] p-10 text-center">
                  <p className="text-sm text-muted-foreground">
                    {search ? "No matching devices found." : "No device data collected yet."}
                  </p>
                </div>
              }
            />
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-xs">
                    {selectedDeviceData.lastSeen
                      ? dayjs(selectedDeviceData.lastSeen).format("MMM D, YYYY h:mm A")
                      : "-"}
                  </span>
                </div>
              </div>
                      ...
                      <div className="flex-1 min-w-0 space-y-1">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {event.createdAt ? dayjs(event.createdAt).fromNow() : "Unknown"}
                          </span>
                        </div>
                        <Link
                          to="/"
