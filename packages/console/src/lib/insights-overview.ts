...
export type InsightsBundleMetadata = {
...
export type LatestReportedBundle = {
  ...
  readonly bundle: InsightsBundleMetadata | null;
};
...
export type ConfiguredRollout = {
  ...
  readonly trackedInstallations: number;
  readonly bundle: InsightsBundleMetadata;
};
...
export const createInsightsOverviewFromCounts = (
  bundles: readonly Bundle[],
  releases: readonly ReleaseRow[],
  channels: readonly ChannelRow[],
  trackedInstallations: number,
...
export const createInsightsOverview = (
  bundles: readonly Bundle[],
  releases: readonly ReleaseRow[],
  channels: readonly ChannelRow[],
