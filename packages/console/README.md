...
- **Hot Updater Integration** - Storage adapter and database adapter integration
...
The console integrates with the configured Hot Updater storage adapter and database adapter through TanStack Start server functions:
...
2. **Server Functions** → TanStack Start server functions call the configured storage adapter and database adapter
...
- Verify the storage adapter and database adapter are correctly initialized
