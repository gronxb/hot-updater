...
import { AnalyticsScanLimitExceededError as BundleEventScanLimitExceededError } from "../../errors";
import {
  ACTIVE_AS_OF_MS,
  DAY_MS,
...
import { ANALYTICS_SCAN_PAGE_SIZE as BUNDLE_EVENT_SCAN_PAGE_SIZE } from "./scan";
...
describe("active installation bounded scan", () => {
  ...
  it("throws the stable typed limit for 50,001 matching rows", async () => {
    ...
    await expect(result).rejects.toMatchObject({
      name: "AnalyticsScanLimitExceededError",
      limit: 50_000,
    });
