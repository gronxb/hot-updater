...
export interface RequiredInsightsMaintenanceStepUsage {
...
export type RequiredInsightsMaintenanceStepResult =
  | {
      readonly state: "complete";
      readonly publicationId: string;
      readonly usage: RequiredInsightsMaintenanceStepUsage;
    }
  | {
...
export interface RequiredInsightsModelOracle {
  readonly model: RequiredInsightsModel;
  readonly otherNamespaceModel: RequiredInsightsModel;
  runJobStep(
    jobId: string,
  ...
  reopen(): RequiredInsightsModelOracle | Promise<RequiredInsightsModelOracle>;
...
const createOracleFacade = (
  ...
  const model = createModel("primary", primary);
  const otherNamespaceModel = createModel("secondary", secondary);
  ...
  return {
    ...
    reopen: () => createOracleFacade(primary, secondary),
...
export const createRequiredInsightsModelOracle =
  (): RequiredInsightsModelOracle =>
    createOracleFacade(createStore(), createStore());
