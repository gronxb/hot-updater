...
import { bundleEventsV032, bundlesV032, v0_32_0 } from "./v0_32_0";
...
describe("versioned schema DSL", () => {
  it("uses the local functional DSL for every versioned schema table", () => {
    ...
    expect(bundlesV032.dsl).toBe("table");
    expect(bundleEventsV032.dsl).toBe("table");
    expect(createSettingsTable("0.32.0").dsl).toBe("table");

    for (const schema of [v0_21_0, v0_29_0, v0_31_0, v0_32_0]) {
