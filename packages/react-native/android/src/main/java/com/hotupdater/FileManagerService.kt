...
interface FileSystemService {
     ...
     */
    fun moveItem(sourcePath: String, destinationPath: String): Boolean
    
    /**
     * Copies a file or directory from source path to destination path
     */
    fun copyItem(sourcePath: String, destinationPath: String): Boolean
 ...
 */
class FileManagerService(private val context: Context) : FileSystemService {
    ...
    override fun moveItem(sourcePath: String, destinationPath: String): Boolean {
    ...
    override fun copyItem(sourcePath: String, destinationPath: String): Boolean {
        val source = File(sourcePath)
        val destination = File(destinationPath)
