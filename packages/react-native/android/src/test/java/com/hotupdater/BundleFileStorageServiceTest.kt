...
class BundleFileStorageServiceTest {
    ...
    @Test
    fun `updateBundle with null fileUrl resets bundle`() = runTest {
        whenever(mockPreferences.getItem("HotUpdaterBundleURL")).thenReturn(null)
    ...
    @Test
    fun `updateBundle uses cached bundle when it exists`() = runTest {
    ...
    @Test
    fun `updateBundle downloads and extracts new bundle successfully`() = runTest {
        val baseDir = File("/data/app")
        val bundleStoreDir = File(baseDir, "bundle-store")
        val finalBundleDir = File(bundleStoreDir, "test-bundle-123")
    ...
    @Test
    fun `updateBundle fails when download fails`() = runTest {
        val baseDir = File("/data/app")
        val bundleStoreDir = File(baseDir, "bundle-store")
        val finalBundleDir = File(bundleStoreDir, "test-bundle-123")
        val tempDir = File(baseDir, "bundle-temp")
    ...
    @Test
    fun `updateBundle fails when unzip fails`() = runTest {
        val baseDir = File("/data/app")
        val bundleStoreDir = File(baseDir, "bundle-store")
        val finalBundleDir = File(bundleStoreDir, "test-bundle-123")
        val tempDir = File(baseDir, "bundle-temp")
    ...
    @Test
    fun `updateBundle fails when bundle file not found after extraction`() = runTest {
        val baseDir = File("/data/app")
        val bundleStoreDir = File(baseDir, "bundle-store")
        val finalBundleDir = File(bundleStoreDir, "test-bundle-123")
        val tempDir = File(baseDir, "bundle-temp")
    ...
    @Test
    fun `different bundle IDs use different directories`() = runTest {
        val baseDir = File("/data/app")
        val bundleStoreDir = File(baseDir, "bundle-store")
    ...
    @Test
    fun `updateBundle progress callback is invoked during download`() = runTest {
        val baseDir = File("/data/app")
        val bundleStoreDir = File(baseDir, "bundle-store")
        val finalBundleDir = File(bundleStoreDir, "test-bundle-123")
        val tempDir = File(baseDir, "bundle-temp")
