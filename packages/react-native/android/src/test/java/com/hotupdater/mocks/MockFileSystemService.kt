...
class MockFileSystemService(
     ...
     */
    fun getOperations(): List<String> = operations.toList()
     ...
     */
    fun getVirtualFiles(): Set<String> = virtualFiles.toSet()
     ...
     */
    fun getVirtualDirectories(): Set<String> = virtualDirectories.toSet()
}
