...
import type { Bundle, BundleArg } from "../../core/dist/index.js";
import { filterTargetAppVersion } from "../../core/dist/index.js";
...
export const checkForUpdate = async (
  ...
  const appVersionBundles = currentAppVersion
    ? filterTargetAppVersion($bundles, currentAppVersion, platform)
    : [];
